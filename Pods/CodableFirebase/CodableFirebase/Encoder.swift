...
class _FirebaseEncoder: Encoder {
    ...
    init(options: _Options, codingPath: [CodingKey] = []) {
        storage = _FirebaseEncodingStorage()
    ...
    public func container<Key>(keyedBy _: Key.Type) -> KeyedEncodingContainer<Key> {
        ...
        let container = _FirebaseKeyedEncodingContainer<Key>(referencing: self, codingPath: codingPath, wrapping: topContainer)
    ...
    public func unkeyedContainer() -> UnkeyedEncodingContainer {
        ...
        return _FirebaseUnkeyedEncodingContainer(referencing: self, codingPath: codingPath, wrapping: topContainer)
    }
...
private struct _FirebaseUnkeyedEncodingContainer: UnkeyedEncodingContainer {
    ...
    public mutating func nestedContainer<NestedKey>(keyedBy _: NestedKey.Type) -> KeyedEncodingContainer<NestedKey> {
        codingPath.append(_FirebaseKey(index: count))
...
private class _FirebaseReferencingEncoder: _FirebaseEncoder {
    ...
    fileprivate init(referencing encoder: _FirebaseEncoder, at index: Int, wrapping array: NSMutableArray) {
        ...
        codingPath.append(_FirebaseKey(index: index))
    }
